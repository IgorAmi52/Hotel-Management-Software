...
public class ReservationService {
	...
	public ReservationService(DataAccessInterface dataAccessService, PricingServiceInterface pricingService,
			ReportsServiceInterface reportsService) {
		this.dataAccessService = dataAccessService;
		this.pricingService = pricingService;
		this.reportsService = reportsService;
	}

	public void requestReservation(Reservation reservation) throws IOException {
	...
	public Reservation[] getReservations(User user) throws IOException {
	...
	public void cancelReservation(Reservation reservation) throws IOException {
	...
	public Reservation[] getTodaysCheckInReservations() throws IOException {
	...
	public Reservation[] getTodaysCheckOutReservations() throws IOException {
	...
	public void proccessReservation(Reservation reservation) throws IOException, NoRoomAvailableException {
		...
		Room room = gson.fromJson(
				roomsObject.getAsJsonObject(reservation.getRoomType()).getAsJsonObject(idsList.get(0)), Room.class); // get
																														// free
																														// room
	...
	public void rejectReservation(Reservation reservation, Boolean isDated) throws IOException {
	...
	public void checkInReservation(Reservation reservation, String[] addServices)
			throws IOException, NoPricingException {
	...
	public void archiveReservation(Reservation reservation) throws IOException {
