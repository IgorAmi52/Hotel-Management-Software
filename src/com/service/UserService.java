...
public class UserService {
	...
	public UserService(DataAccessInterface dataAccessService) {
	...
	public Guest getGuest(String username) throws IOException {
		JsonObject jsonObject = dataAccessService.getData(DataTypes.USERS);
	...
	public Staff getStaff(String username) throws IOException {
		JsonObject jsonObject = dataAccessService.getData(DataTypes.USERS);
