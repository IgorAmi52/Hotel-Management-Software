...
public class ManageReservationsPanel extends JPanel implements Panel {
	...
	public ManageReservationsPanel() {
        ...
        JScrollPane addScrollPane = new JScrollPane(addCheckBoxPanel,JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
        ...
        JScrollPane typeScrollPane = new JScrollPane(typeCheckBoxPanel,JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
        ...
        JScrollPane roomScrollPane = new JScrollPane(roomCheckBoxPanel,JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
